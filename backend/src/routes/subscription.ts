...
<script>
  (() => {
    ...
    const namedSubscriptionUrl = subscriptionUrl + "#" + subscriptionName;
    document.getElementById("import-v2box").href =
      "v2box://install-sub?url=" + encodeURIComponent(namedSubscriptionUrl) + "&name=" + encodeURIComponent(subscriptionName);
